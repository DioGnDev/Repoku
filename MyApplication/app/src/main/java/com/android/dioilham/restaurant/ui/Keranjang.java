    ...
    class LoadAllItemsCart extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            for (int i = 0; i < haha.size(); i++) {
                ...
                Log.d("KODE ITEM", data.getKodeCart());
...
//        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    class CheckOutItems extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            Log.d("QTY TOTAL", String.valueOf(qtyTotal));
            ...
            Log.d("PARAM TRANSAKSI", paramData.toString());
            JSONObject jsonObject = jParser.makeHttpRequest(url, "POST", paramData);
            Log.d("STATUS TRANSAKSI SIMPAN", jsonObject.toString());
            try {
                ...
                if (success == 1) {
                    ...
                    for (int i = 0; i < ic.size(); i++) {
                        ...
                        Log.d("STATUS TRANSAKSI DETIL", jsonObject.toString());
                    }
                } else {
                    flag = false;
                }
