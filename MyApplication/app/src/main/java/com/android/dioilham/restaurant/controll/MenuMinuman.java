...
//    private static String url_menu_minuman = "http://192.168.56.1/restaurant_server/getdrink.php";
    ...
    private static final String TAG_FD = "drink";
    private static final String TAG_KODE = "kode_drink";
    private static final String TAG_NAMA = "nama_drink";
    private static final String TAG_HARGA = "harga_drink";
    private static final String TAG_JENIS = "jenis_drink";
    private static final String TAG_KETERANGAN = "keterangan_drink";
    private static final String TAG_GAMBAR = "gambar_drink";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listdrink.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String gambar = mimik.getGambar();
                String pesan = "Tambahkan " + "'" + nama + "'" + " ke Daftar Item Transaksi?";

                tampilDialog(pesan,kode,nama,harga,ket);
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    for (int i = 0; i < minuman.length(); i++) {
                        ...
                        String gambar = object.getString(TAG_KETERANGAN);

                        Minuman minuman = new Minuman();
                        minuman.setKode(kode);
